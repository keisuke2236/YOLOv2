...
class Darknet19(Chain):
    ...
    def __call__(self, x):
        ...
        ##### common layer
        h = F.leaky_relu(self.bn1(self.conv1(x), test=not self.train), slope=0.1)
        h = F.max_pooling_2d(h, ksize=2, stride=2, pad=0)
        h = F.leaky_relu(self.bn2(self.conv2(h), test=not self.train), slope=0.1)
        h = F.max_pooling_2d(h, ksize=2, stride=2, pad=0)
        h = F.leaky_relu(self.bn3(self.conv3(h), test=not self.train), slope=0.1)
        h = F.leaky_relu(self.bn4(self.conv4(h), test=not self.train), slope=0.1)
        h = F.leaky_relu(self.bn5(self.conv5(h), test=not self.train), slope=0.1)
        h = F.max_pooling_2d(h, ksize=2, stride=2, pad=0)
        h = F.leaky_relu(self.bn6(self.conv6(h), test=not self.train), slope=0.1)
        h = F.leaky_relu(self.bn7(self.conv7(h), test=not self.train), slope=0.1)
        h = F.leaky_relu(self.bn8(self.conv8(h), test=not self.train), slope=0.1)
        h = F.max_pooling_2d(h, ksize=2, stride=2, pad=0)
        h = F.leaky_relu(self.bn9(self.conv9(h), test=not self.train), slope=0.1)
        h = F.leaky_relu(self.bn10(self.conv10(h), test=not self.train), slope=0.1)
        h = F.leaky_relu(self.bn11(self.conv11(h), test=not self.train), slope=0.1)
        h = F.leaky_relu(self.bn12(self.conv12(h), test=not self.train), slope=0.1)
        h = F.leaky_relu(self.bn13(self.conv13(h), test=not self.train), slope=0.1)
        h = F.max_pooling_2d(h, ksize=2, stride=2, pad=0)
        h = F.leaky_relu(self.bn14(self.conv14(h), test=not self.train), slope=0.1)
        h = F.leaky_relu(self.bn15(self.conv15(h), test=not self.train), slope=0.1)
        h = F.leaky_relu(self.bn16(self.conv16(h), test=not self.train), slope=0.1)
        h = F.leaky_relu(self.bn17(self.conv17(h), test=not self.train), slope=0.1)
        h = F.leaky_relu(self.bn18(self.conv18(h), test=not self.train), slope=0.1)
